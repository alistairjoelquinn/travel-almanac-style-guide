...
export const addCommonWordsToState = async (
...
export const addPunctuationToState = async (
  dispatch: React.Dispatch<Action>
) => {
  const {
    data: { allPunctuation },
...
export const addDatesNumbersToState = async (
  dispatch: React.Dispatch<Action>
) => {
  const {
...
export const addBestPracticeToState = async (
  dispatch: React.Dispatch<Action>
) => {
  const {
...
export const addQuickFormattingToState = async (
  dispatch: React.Dispatch<Action>
) => {
  const {
...
export const userSearchEnd = async (dispatch: React.Dispatch<Action>) =>
  dispatch({ type: 'USER_SEARCH_ENDED' });
